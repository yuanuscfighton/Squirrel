...
// 使用RTK构建store
// 第2步【1】createSlice 创建reducer切片
const studentSlice = createSlice({ // options是一个配置对象

  // 属性1：用于自动生成action对象中的type的常量值
  name: 'stu',
 ...
 *
 * 说明：
 *  参数1："type":"stu/setName" —— “stu”就是在属性1中定义的值+函数名，即，type:name/函数名
 *  参数2："payload":"王五" —— 就是我们往setName(...)函数中传入的值
 *
...
//////////////////////////////////////////////////////////////////////////////////////////////
// 第3步：configureStore()用来，创建store对象，需要配置对象作为参数
